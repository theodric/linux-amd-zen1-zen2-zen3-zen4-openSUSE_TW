...
#sudo CXXFLAGS="-Ofast -pipe -march=znver3 -mtune=znver3 -fstack-protector-strong" CFLAGS="-Ofast -pipe -march=znver3 -mtune=znver3 -fstack-protector-strong" KCFLAGS="-Ofast -pipe -march=znver3 -mtune=znver3 -fstack-protector-strong" make -j $(($(nproc) + 1));
